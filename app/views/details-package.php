                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                      ...
                      <tr>
                        <td colspan="8"><strong>Observaciones: </strong>Lorem ipsum dolor sit amet,
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-envelope"></i> Enviar mensaje</h4>
              </div>
              <div class="modal-body">
                ...
                <form action="" method="post">
                  ...
                  <br />
                  <button type="submit" value="sub" name="sub" class="btn btn-primary"><i class="fa fa-share"></i> Enviar</button>
                </form>
              </div>
