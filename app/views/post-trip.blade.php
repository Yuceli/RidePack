      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                {{Form::select('travel', array(null => 'Estoy viajando...', '1'=>'Via terrestre', '2'=>'Via áerea', '3'=>'Vía marítima'), null, array('class' => 'form-control input-lg', 'id' => 'travel', 'name' => 'travel', 'required' => 'required'))}}
                <div>{{ $errors -> first('travel')}}</div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6">
              <div class="form-group">
                {{Form::select('package', array('' => 'Puedo transportar un paquete...', '1'=>'Extra pequeño', '2'=>'Pequeño', '3'=>'Mediano', '4'=>'Grande', '5'=>'Extra grande'), null, array('class' => 'form-control input-lg', 'id' => 'package', 'name' => 'package', 'required'=>'required'))}}
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
              {{Form::number('quantity', null, array('id'=>'quantity', 'name'=>'quantity', 'min' => '1', 'max' => '15', 'class'=>'form-control input-lg','tabindex'=>'5', 'placeholder' => 'Peso en Kg', 'required'=>'true'))}}
              <div>{{ $errors->first('quantity') }}</div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group">
              {{Form::number('volume', null, array('id'=>'volume', 'name'=>'volume', 'min' => '1', 'max' => '15', 'class'=>'form-control input-lg','placeholder'=>'Volumen del paquete','tabindex'=>'5',  'required'=>'true'))}}
        ...
        <div class="form-group">
          {{Form::text('search_from_city', null, array('id'=>'search_from_city','class'=>'form-control input-lg', 'name'=>'ciudad_salida', 'placeholder'=>'Ciudad de salida','tabindex'=>'3', 'required'=>'required'))}}
        ...
        <div class="form-group">
            {{Form::text('search_to_city', null, array('id'=>'search_to_city', 'name'=>'ciudad_destino' ,'class'=>'form-control input-lg','placeholder'=>'Ciudad de destino','tabindex'=>'4', 'required'=>'required'))}}
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
              <input type="text" name="departure_date" id="date" class="form-control input-lg" placeholder="Fecha de salida" required="required" tabindex="5" onfocus="(this.type='date')" onblur="(this.type='text')" >
               <div>{{ $errors->first('departure_date') }}</div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="form-group">
              <input type="text" name="arrival_date" id="date" class="form-control input-lg" placeholder="Fecha de llegada" required="required" tabindex="5" onfocus="(this.type='date')" onblur="(this.type='text')">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6  col-sm-offset-3">
          {{Form::submit('Publicar mi viaje', array('class'=>'btn btn-primary btn-block btn-lg','tabindex'=>'7', 'value'=>'Publicar mi viaje'))}}
        </div>
      </div>
    </div>
  </div>
